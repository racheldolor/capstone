-- Clean database backup for web hosting - SAFE VERSION
-- This version safely handles existing tables with foreign keys
...
-- Drop all tables in safe order (reverse dependencies)
...
-- Now create all tables in dependency order
