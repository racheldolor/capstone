...
if (!isset($_SESSION['logged_in']) || !in_array($_SESSION['user_role'], ['head', 'central', 'director', 'admin'])) {
...
try {
    ...
    foreach ($certificates as &$cert) {
        ...
        // Ensure file path is web-accessible from head-staff directory
    ...
    error_log("Get student certificates error: " . $e->getMessage());
    echo json_encode([
        'success' => false, 
